...
<!-- isinya -->
    <h1 class="h3 mb-0">
        Data Barang
        <button class="btn btn-primary btn-sm border-0 float-right" type="button" data-toggle="modal" data-target="#TambahProduk">Tambah Barang</button>
    </h1>
<hr>
    ...
    <div class="modal-content border-0">
      ...
      <div class="modal-body">
        <div class="form-group">
            <label class="samll">Kode Barang :</label>
