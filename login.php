...
<head>
    ...
    <title>Login Aplikasi Kasir | Kelompok 1 Informatika untuk Masyarakat</title>
...
<body class="text-center">
    ...
    <form class="form-signin" method="POST">
      <img class="mb-4" src="assets/images/kasir.jpg" alt="" width="72" height="72">
      ...
      <p class="mt-3 mb-3 text-white"> Kelompok 1 - <a target="_blank" rel="noopener noreferrer" href="https://adgrafika.my.id" class="text-white">
     Informatika Untuk Masyarakat </a></p>
    </form>
